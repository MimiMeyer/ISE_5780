...
class GeometriesTest {
    ...
    void findIntsersections() {
        ...
        assertNull(geometries.findIntersections(new Ray(new Point3D(0.0,0.0,2.0), new Vector(0.0,-1.0,0.0))));

        //TC03: just one geometry has intersections point
        assertEquals( 1, geometries.findIntersections(new Ray(new Point3D(0.0,5.0,-1.0), new Vector(0.0,0.0,1.0))).size());
