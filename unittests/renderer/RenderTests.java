 ...
 */
        ...
        scene.addGeometries(new Sphere(50, new Point3D(0, 0, 100), new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 100)));

        scene.addGeometries(
        new Triangle(new Color(java.awt.Color.BLUE), new Point3D(100, 0, 100), new Point3D(0, 100, 100), new Point3D(100, 100, 100)),
        new Triangle(new Color(java.awt.Color.BLUE), new Point3D(100, 0, 100), new Point3D(0, -100, 100), new Point3D(100, -100, 100)),
        new Triangle(new Color(java.awt.Color.BLUE), new Point3D(-100, 0, 100), new Point3D(0, 100, 100), new Point3D(-100, 100, 100)),
        new Triangle(new Color(java.awt.Color.BLUE), new Point3D(-100, 0, 100), new Point3D(0, -100, 100), new Point3D(-100, -100, 100)));
        ...
        new Triangle(
                new Color(java.awt.Color.BLUE), new Point3D(100, 0, 100), new Point3D(0, -100, 100), new Point3D(100, -100, 100)),    // upper right
