...
public class CameraIntegrationTest {
    ...
    void constructRayThroughPixelWithSphere() {
        ...
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 3; ++j) {
                results2 = sph1.findIntersections(camera2.constructRayThroughPixel(Nx, Ny, j, i, 1, 3, 3));
                if (results2 != null)
                    count += results2.size();
            }
        }
        ...
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 3; ++j) {
                results3 = sph3.findIntersections(camera2.constructRayThroughPixel(Nx, Ny, j, i, 1, 3, 3));
                if (results3 != null)
                    count += results3.size();
            }
        }
        ...
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 3; ++j) {
                results4 = sph4.findIntersections(camera1.constructRayThroughPixel(Nx, Ny, j, i, 1, 3, 3));
                if (results4 != null)
                    count += results4.size();
            }
        }
        ...
        for (int i = 0; i < 3; ++i) {
            for (int j = 0; j < 3; ++j) {
                results5 = sph5.findIntersections(camera1.constructRayThroughPixel(Nx, Ny, j, i, 1, 3, 3));
                if (results5 != null)
                    count += results5.size();
            }
        }
    ...
    void constructRayThroughPixelWithPlane() {
        ...
        for (int i = 0; i < Ny; ++i) {
            for (int j = 0; j < Nx; ++j) {
                results = p.findIntersections(camera1.constructRayThroughPixel(Nx, Ny, j, i, 1, 3, 3));
                if (results != null)
                    count += results.size();
            }
        }
    ...
    void constructRayThroughPixelWithTriangle() {
        ...
        for (int i = 0; i < Ny; ++i) {
            for (int j = 0; j < Nx; ++j) {
                results = t.findIntersections(camera1.constructRayThroughPixel(Nx, Ny, j, i, 1, 3, 3));
                if (results != null)
                    count += results.size();
            }
        }
